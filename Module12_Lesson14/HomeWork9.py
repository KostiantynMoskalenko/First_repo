...
class Contacts:
    ...
    def __copy__(self):
        copy_contacts = Contacts(self.filename)
    ...
    def __deepcopy__(self, memo):
        deep_copy_contacts = Contacts(self.filename)
        memo[id(deep_copy_contacts)] = deep_copy_contacts
        deep_copy_contacts.filename = copy.deepcopy(self.filename)
        deep_copy_contacts.contacts = copy.deepcopy(self.contacts)
        deep_copy_contacts.is_unpacking = copy.deepcopy(self.is_unpacking)
        deep_copy_contacts.count_save = copy.deepcopy(self.count_save)
